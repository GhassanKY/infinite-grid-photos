...
Each deletable image is implemented as a native `<button>`, allowing navigation with **Tab** and activation with **Enter** or **Space**.
...
AI was also used to generate this README.
